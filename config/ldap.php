            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', 'akij.net')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'dc=akij,dc=akij,dc=net'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME', 'akash.corp'),
                'password' => env('LDAP_PASSWORD', '9122Jan21'),
